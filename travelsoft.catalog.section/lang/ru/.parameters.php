...
$MESS["CP_BCS_SET_BROWSER_TITLE"] = "Устанавливать заголовок окна браузера";
...
$MESS["CP_BCS_PARTIAL_PRODUCT_PROPERTIES"] = "Разрешить добавлять в корзину товары, у которых заполнены не все характеристики";
...
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_EXT"] = "Товары, которых нет на складах";
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_HIDE"] = "не отображать";
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_LAST"] = "показывать в конце";
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_SHOW"] = "показывать в общем списке";
$MESS["CP_BCS_DISPLAY_COMPARE"] = "Разрешить сравнение товаров";
$MESS["CP_BCS_COMPARE_PATH"] = "Путь к странице сравнения";
$MESS["CP_BCS_USE_MAIN_ELEMENT_SECTION"] = "Использовать основной раздел для показа элемента";
$MESS["CP_BCS_SET_LAST_MODIFIED"] = "Устанавливать в заголовках ответа время модификации страницы";
$MESS["CP_BCS_SECTION_CODE_PATH"] = "Путь из символьных кодов раздела";
$MESS["T_IBLOCK_BACKGROUND_IMAGE"] = "Установить фоновую картинку для шаблона из свойства";
$MESS["CP_BCS_DISABLE_INIT_JS_IN_COMPONENT"] = "Не подключать js-библиотеки в компоненте";
...
$MESS["CP_BCS_SET_META_KEYWORDS"] = "Устанавливать ключевые слова страницы";
$MESS["CP_BCS_SET_META_DESCRIPTION"] = "Устанавливать описание страницы";
...
$MESS['CP_AFP_ID'] = 'ID элемента(ов)(если несколько значений, то указывать через запятую)';
$MESS['CP_AFP_MIN_VAL'] = "(минимальное значение)";
$MESS['CP_AFP_MAX_VAL'] = "(максимальное значение)";
$MESS['CP_AFP_GROUP_NAME'] = "Дополнительные параметры фильтрации для вывода элементов";
$MESS['CP_AFP_CHOOSE'] = "Выберите";
$MESS['CT_AFP_PRICEFORTYPE'] = "Цена типа";
?>