	...
	$arPrice = CCatalogIBlockParameters::getPriceTypesList();
              $db_pt = CCatalogGroup::GetList(
                            ...
                            while ($pt = $db_pt->Fetch()) {
                                $additionalParams[$param_prefix ."MIN_CATALOG_PRICE_".$pt["ID"]] = array(
                                                    "PARENT" => "AFP",
                                                    "NAME" => GetMessage("CT_AFP_PRICEFORTYPE") . " " . $pt["NAME_LANG"] .GetMessage("CP_AFP_MIN_VAL"),
                                                    "TYPE" => "STRING",
                                                 );
                                $additionalParams[$param_prefix ."MAX_CATALOG_PRICE_".$pt["ID"]] = array(
                                                    "PARENT" => "AFP",
                                                    "NAME" => GetMessage("CT_AFP_PRICEFORTYPE") . " " . $pt["NAME_LANG"] .GetMessage("CP_AFP_MAX_VAL"),
                                                    "TYPE" => "STRING",
                                                 );
                            }
}
